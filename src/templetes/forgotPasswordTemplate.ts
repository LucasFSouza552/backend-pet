export default function forgotPasswordTemplate(name: string, token: string): string {
    return `
    <div style="
    ...
    <div style="
        ...
        <div style="padding: 30px 25px; text-align: center; color: #332630;">
            <h2 style="color: #B648A0; font-size: 24px; margin-bottom: 20px;">Recuperação de Senha</h2>
            <p style="font-size: 16px; margin-bottom: 20px;">Olá, ${name},</p>
            <p style="font-size: 16px; margin-bottom: 30px;">
                Recebemos uma solicitação para redefinir a senha da sua conta MyPets.
                Para criar uma nova senha, clique no botão abaixo:
            </p>

            <a href="http://localhost:3000/reset-password?token=${token}" style="
            ...
            <p style="font-size: 14px; color: #61475C; margin-top: 30px;">
                Se você não solicitou a redefinição de senha, ignore este email. Recomendamos que altere sua senha
                imediatamente.
            </p>
        </div>
